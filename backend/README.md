...
## Project Structure
    ...
    ├── united_travel_advis_32184  # Django project configurations
...
1. Clone this repo and `cd united_travel_advis_32184`
...
2. Clone this repo and `cd united_travel_advis_32184`
